...
type OutboundReferenceService interface {
	...
	GetLeaguesSettings(ctx context.Context, params *models.OptionalLeagueParams) (Response[models.LeagueSetting], error)
	...
	GetPlayersRef(ctx context.Context, leagueIds []int64, params *models.OptionalPlayerParams) (Response[models.Player], error)
